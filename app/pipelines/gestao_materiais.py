...
def capanema():
    ...
    lx = LX.LX(os.environ['LX_PATH_CAPANEMA'])
    lx_sinosteel = LX.LX(r'C:\Users\EmmanuelSantana\VERUM PARTNERS\VERUM PARTNERS - VAL2018021\00.TI\Proj - Capanema\SMAT\LX\SINOSTEEL\LX_GERAL_SINOSTEEL')
